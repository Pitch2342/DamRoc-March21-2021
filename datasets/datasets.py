...
class PortableExecutableDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self._is_synthetic:
            ...
            print("FAL")
            print(self.file_abs_locations[idx])
            if self.use_pickle:
...
def load_data(parameters):
    ...
    # assertion
    # print("ASSERTION")
    # # print(train_malicious_dataset.size())
    # print("X")
    # print(train_malicious_dataset[0].size())
    # print("Y")
    # print(train_malicious_dataset[0][0].size())
    # print("Z")
    ...
    print("This is trainMalicious",malicious_files_abs_locs)
